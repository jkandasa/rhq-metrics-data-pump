...
public class RestRealTimeMetricsJob extends RHQMTServer{
    ...
    public static JobDetail[] getList() throws Exception{
        ...
        return (JobDetail[]) RHQMTServer.getClient().get(RESTUri.RHQ_METRICS_JOB_REAL_TIME, JobDetail[].class);
    }
    ...
    public static void add(JobDetail jobDetail) throws Exception{
        ...
        RHQMTServer.getClient().post(RESTUri.RHQ_METRICS_JOB_REAL_TIME, jobDetail);
    }
    ...
    public static void delete(JobDetail jobDetail) throws Exception{
        ...
        RHQMTServer.getClient().delete(RESTUri.RHQ_METRICS_JOB_REAL_TIME, jobDetail);
    }
}
